<footer class="text-gray-600 dark:text-gray-200 dark:bg-gray-800 body-font">
    <div class="container flex flex-col items-center px-5 py-8 mx-auto sm:flex-row">
      ...
      <p class="mt-4 text-sm text-gray-500 dark:text-gray-100 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0">© 2021 MovieApp —
        <a href="https://twitter.com/knyttneve" class="ml-1 text-gray-600 dark:text-gray-300" rel="noopener noreferrer" target="_blank">@patriciaGM</a>
      </p>
