<section class="container mx-auto p-6 font-mono">
    <div class="w-full flex mb-4 p-2 justify-end">
        <form class="flex space-x-4 shadow bg-white rounded-md m-2 p-2">
            <div class="p-1 flex items-center">
                <label for="tmdb_id_g" class="block text-sm font-medium text-gray-700 mr-4">Season Nr</label>
                    ...
                    @foreach ($seasons as $season)
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-ms font-semibold border">
                                <img class='w-12 h-12 rounded-full' src="https://www.themoviedb.org/t/p/original/{{$season->poster_path}}" alt="">
                            </td>
    ...
    <x-jet-dialog-modal wire:model="showSeasonModal">
                    ...
                    <form>
                        <div class="shadow overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                <div class="flex flex-col">
                                    <label for="first-name" class="block text-sm font-medium text-gray-700 mr-4">Season
                                        Nr</label>
        ...
        <x-slot name="footer">
            <x-m-button wire:click="closeSeasonModal" class="bg-gray-600 hover:bg-gray-800 text-white">Cancel
            </x-m-button>
