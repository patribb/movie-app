                    ...
                    <form>
                        <div class="shadow overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                <div class="flex flex-col">
                                    <label for="runtime" class="block text-sm font-medium text-gray-700 mr-4">Episode
                                        Nr</label>
                                ...
                                <div class="flex flex-col">
                                    <label for="poster_path" class="block text-sm font-medium text-gray-700 mr-4">Episode
                                        Nr</label>
                                    <input wire:model="poste_path" type="text" autocomplete="given-name"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                    @error('poster_path')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
